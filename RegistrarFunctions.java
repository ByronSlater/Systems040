...
public class RegistrarFunctions {
     ...
     * should never return a username that already exists
     */
    ...
    /**
     * Tells us if a studentperiod is a resit by retrieving studentID and DegreeLevel 
	 * from StudentPeriod and checking whether the StudentPeriod table contains another
	 * row with the same instances.
     */
     ...
     * This cascades and deletes the student's user account from the system also.
     */
	...
	/**
	* Function employed to add a module to a particular student's StudentPeriod,
	* inserting a new row into the Grades table to represent this.
	*/
    ...
    /**
     * Function employed to list optional modules for a student. 
	 * An empty list indicates all credits have been allocated.
	 * Function retrieves the current (highest) PeriodID from StudentPeriod for a
	 * particular student, retrieves the optional credits available, and determines
	 * which optional modules - if any - are available for selection.
     * @throws SQLException
     */
    ...
    /**
     * Function employed to return the total number of core credits for a students current degree course.
	 * Any additional credits available outside the scope of this function are optional.
     */
