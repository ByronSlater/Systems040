...
public class RegistrarFunctions {
	...
	/**
	 * Function employed to add a student to the Student table with given details. Also registers students for their degree.
	...
	/**
	 * Function employed to remove student details. Takes the student username and deletes them from the UserAccount table. 
	...
	/**
	 * Function employed to register a student for a study period by adding a new row to the StudentPeriod table.
	 */
	...
	/**
	 * Function employed to add an optional module to a particular student. 
	 * Creates an entry for the module in the Grades table and links it to the relevant StudentPeriod.
	 * @param Module
	 * @param StudentPeriod
	 */
	...
	/**
	 * Function employed to list optional modules for a student. An empty list indicates no more credits are available.
	 * @throws SQLException
	 */
	...
	/**
	 * Function employed to retrieve the total number of credits for a student's current degree course.
	 */
